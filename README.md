...
### Link to live preview on streamlit - https://e-commerce-chatbot-fk.streamlit.app/
...
- **small-talk**:Activated when user asks questions form daily life.

![product screenshot](app/resources/product-ss.png)
![product screenshot](app/resources/smalltalk.png)
